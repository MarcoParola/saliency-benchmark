...
def main(cfg):
    ...
    if save_images:
        ...
        output_dir_images = os.path.join(cfg.currentDir, 'saliency_output/lime_saliency_maps_images',
                                         finetune + cfg.model + cfg.dataset.name)
        output_dir_tensors = os.path.join(cfg.currentDir, 'saliency_output/lime_saliency_maps_tensors',
                                          finetune + cfg.model + cfg.dataset.name)
